...
const _addToDOMArray = (id, element) => {
  ...
  moveByAnimation(detachedEl, [arrPos.x, arrPos.y, arrPos.z], false, () => {
    ...
    moveByAnimation(detachedEl, [xOffset, 0, 0]);
  });
};
